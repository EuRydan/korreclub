      ...
      <AnimatePresence>
        {showScroll && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="w-12 h-12 rounded-full bg-[#141414] text-[#E3E2DE] flex items-center justify-center shadow-lg hover:bg-[#1351AA] hover:text-white transition-colors duration-300"
